        ...
        <div className="w-full h-64 flex flex-col items-center justify-center gap-4 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 p-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={handleChange}
              disabled={uploading}
              className="px-4 py-2.5 bg-transparent text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              type="button"
              onClick={() => setShowMediaLibrary(true)}
              className="px-4 py-2.5 bg-transparent text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-sm whitespace-nowrap"
            >
              ライブラリから選択
            </button>
            ...
            {showImageGenerator && (
              <button
                ...
                className="px-4 py-2.5 bg-transparent text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-sm"
              >
